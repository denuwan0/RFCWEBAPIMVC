...
namespace RFCWEBAPIMVC.SapConnection
{
    public class SapConn
    {
        ...
        //create Sap RfcDestination
        public RfcDestination SapConnection()
        {
            if (dest == null)
            {
                ...
                dest = SAP.Middleware.Connector.RfcDestinationManager.GetDestination(parms);
                return dest;
            }
            return dest;
        ...
        //create Sap Repository
        public RfcRepository sapRepo(RfcDestination dest)
        {
            try
            {
